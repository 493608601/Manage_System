...
* 修改/完善：YouAreStupid
*/
public class CalendarPanel extends JButton {
   ...
   public CalendarPanel(String dateString) {
       this();
   ...
   public CalendarPanel(SimpleDateFormat df, String dateString) {
       this();
   ...
   public CalendarPanel(String preLabel, Date date) {
       if (preLabel != null) {
...
//           result.add(secondLabel);
       ...
       void showDateChooser(Point position) {
           Frame owner = (Frame) SwingUtilities.getWindowAncestor(CalendarPanel.this);
